...
const FAQ = () => {
  ...
  const faqs = [
    {
      question: 'CodeFlow 가입 절차는 어떻게 되나요?',
      answer: '①양식 작성 → ②멤버십 결제(래피드) → ③운영진 심사 → ④최종 승인 순으로 진행됩니다. 결제는 안전한 간편결제 서비스 래피드(Latpeed)를 통해 이루어지며, 심사 승인 후 Discord 초대 링크가 발송됩니다.'
    },
    {
      question: '멤버십 비용은 얼마인가요?',
      answer: '래피드 결제 페이지에서 확인하실 수 있습니다. 양질의 커뮤니티 운영과 정기 모임, 학습 자료 제공 등을 위해 최소한의 멤버십 비용이 발생합니다.'
    },
    {
      question: '어떤 플랫폼을 사용하나요?',
      answer: 'Discord를 메인으로 사용하며, Slack 채널도 운영할 예정입니다. 가입 승인 후 초대 링크를 받으실 수 있습니다.'
    },
    {
